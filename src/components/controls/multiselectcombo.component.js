...
const CbMultiSelectCombo = ({ onchange, onblur, placeholder, fields,
    ...
    hideSelectedItem, noRecordsTemplate, readOnly,valueTemplate,query ,actionBegin,actionComplete,
    actionFailure,beforeOpen,close }) => {
    const enableRtl = useSelector(state => state.loggedInDetails.OtherInfo.isRTL);
    return (
        <MultiSelectComponent id={propertyName} dataSource={items} 
        name={propertyName}
...
export default CbMultiSelectCombo;
